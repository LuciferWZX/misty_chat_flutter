        ...
        children:[
          Flex(
            ...
            children: [
              GFAvatar(
                  size: 120,
                  backgroundImage:NetworkImage("${contactController.friend.value.avatar}" ?? "")
              ),
              const SizedBox(height: 24),
              Text(
                  "${contactController.friend.value.nickname}",
              ...
              Text(
                "${contactController.friend.value.username}",
                style: const TextStyle(
                    fontWeight: FontWeight.w400,
                    fontSize: 16,
                ),
              ...
              NormalListItem(
                ...
                prefix: Icon(Icons.chat_outlined),
                title: "聊天",
              ),
              NormalListItem(
                onTap: (){
                ...
                prefix: Icon(Icons.person_remove_sharp),
                title: "删除好友",
              ),
            ],
          )
